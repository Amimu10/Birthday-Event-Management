...
const Footer = () => {
  return (
   ...
   <div className="p-10 grid grid-cols-1 md:grid-cols-3 bg-[#ABCE4E] my-20 text-center">
      <div>
        <h3 className="text-white text-2xl font-young">Get in Touch</h3>
        <p className="font-young text-xl my-4">Paribag, Dhaka<br/>Dhaka, 1000</p> 
      </div>
      <div>
        <h3 className="text-white font-extrabold text-2xl font-young">Terms & Conditions</h3>
      ...
      <div className="flex flex-col items-center"> 
        <h3 className="text-white text-2xl font-young">Social</h3>
      ...
      <div className="text-center">
        <p className="block text-lg text-white font-young">Copyright © 2023 - All right reserved</p> 
      </div>
    </div>
    </div>
