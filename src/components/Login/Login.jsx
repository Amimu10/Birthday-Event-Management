...
const Login = () => {
  ...
  return (
    <div data-aos="zoom-in-down">
     ...
     <button onClick={handleGoogleSign} className="flex items-center border rounded-md border-[#FDBF05] bg-white px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200">
...
<p className="text-center text-2xl text-[#A3A3A3] font-semibold font-young mt-3">Or</p>
